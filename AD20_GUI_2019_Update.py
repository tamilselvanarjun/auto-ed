...
if __name__ == '__main__':
    ...
    def graph_window(master):
        ...
        def draw_graph():
            ...
            fig = ADgraph.draw_graph(function_output(ADnum(value_x.get(),ins=6,ind=0),ADnum(value_y.get(),ins=6,ind=1),ADnum(value_z.get(),ins=6,ind=2),
                                     ADnum(value_m.get(),ins=6,ind=3),ADnum(value_n.get(),ins=6,ind=4),ADnum(value_k.get(),ins=6,ind=5)))
    ...
    #         fig = ADgraph.gen_table(function_output)
            ...
            df = ADgraph.gen_table(function_output(ADnum(value_x.get(),ins=6,ind=0),ADnum(value_y.get(),ins=6,ind=1),ADnum(value_z.get(),ins=6,ind=2),
                                     ADnum(value_m.get(),ins=6,ind=3),ADnum(value_n.get(),ins=6,ind=4),ADnum(value_k.get(),ins=6,ind=5)))
        ...
        value_prompt_m = tk.Label(graph_window, text = "  Evaluate at m =  ",height = 3, width = 10).grid(row = 5, column = 0)
        enter_value_m= tk.Entry(graph_window, textvariable = value_m, width = 10).grid(row = 5, column = 1)
        value_prompt_n= tk.Label(graph_window, text = "  Evaluate at n = ",height = 3, width = 10).grid(row = 6, column = 0)
        enter_value_n= tk.Entry(graph_window, textvariable = value_n, width = 10).grid(row = 6, column = 1)
        value_prompt_k= tk.Label(graph_window, text = "  Evaluate at k = ",height = 3, width = 10).grid(row = 7, column = 0)
        ...
        def display():
            ...
            show_value = tk.Label(graph_window, text = str(function_output(ADnum(value_x.get(),ins=6,ind=0),ADnum(value_y.get(),ins=6,ind=1),ADnum(value_z.get(),ins=6,ind=2),
                                     ADnum(value_m.get(),ins=6,ind=3),ADnum(value_n.get(),ins=6,ind=4),ADnum(value_k.get(),ins=6,ind=5)).val),height = 3, width = 20).grid(row = 9, column = 1, columnspan = 2)
            show_derivatice = tk.Label(graph_window, text = str(function_output(ADnum(value_x.get(),ins=6,ind=0),ADnum(value_y.get(),ins=6,ind=1),ADnum(value_z.get(),ins=6,ind=2),
                                     ADnum(value_m.get(),ins=6,ind=3),ADnum(value_n.get(),ins=6,ind=4),ADnum(value_k.get(),ins=6,ind=5)).der),height = 3, width = 20).grid(row = 10, column = 1, columnspan = 2)
        result_val = tk.Label(graph_window, text = "Value:",height = 3, width = 10).grid(row =9, column =0)
        result_der = tk.Label(graph_window, text= "Derivative: ",height = 3, width = 10).grid(row = 10, column = 0)
    ...
    #     graph_window(master)
        try:
            function_output = lambda x,y,z,m,n,k: eval(function_expression)
    #         graph_window(master)
        except:
    #         error_window(master)
    #         raise exception("expression error")
        ...
        try:
            textVal = function_output(ADnum(5,ins=6,ind=0),ADnum(4,ins=6,ind=1),ADnum(3,ins=6,ind=2),
                                     ADnum(2,ins=6,ind=3),ADnum(1,ins=6,ind=4),ADnum(6,ins=6,ind=5)).val
            textDer = function_output(ADnum(5,ins=6,ind=0),ADnum(4,ins=6,ind=1),ADnum(3,ins=6,ind=2),
                                     ADnum(2,ins=6,ind=3),ADnum(1,ins=6,ind=4),ADnum(6,ins=6,ind=5)).der
    ...
    button_m = tk.Button(cal_frame, text = "m", font=('wasy10', 20),fg = "magenta",height=2, width=5,command = var_number_m).grid(row = 6, column = 2)
    button_n = tk.Button(cal_frame, text = "n", font=('wasy10', 20),fg = "magenta",height=2, width=5,command = var_number_n).grid(row = 6, column = 3) 
    button_k = tk.Button(cal_frame, text = "k", font=('wasy10', 20),fg = "magenta",height=2, width=5,command = var_number_k).grid(row = 6, column = 4) 
